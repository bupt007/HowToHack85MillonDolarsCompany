...
.method constructor <init>(Lcom/parse/OfflineStore;Lcom/parse/ParseSQLiteDatabase;Lcom/parse/ParseObject;)V
    ...
    iput-object p2, p0, Lcom/parse/OfflineStore$38;->val$db:Lcom/parse/ParseSQLiteDatabase;

    iput-object p3, p0, Lcom/parse/OfflineStore$38;->val$object:Lcom/parse/ParseObject;
...
.method public then(Lbolts/Task;)Lbolts/Task;
    ...
    iget-object v6, p0, Lcom/parse/OfflineStore$38;->this$0:Lcom/parse/OfflineStore;

    iget-object v7, p0, Lcom/parse/OfflineStore$38;->val$db:Lcom/parse/ParseSQLiteDatabase;

    # invokes: Lcom/parse/OfflineStore;->getPointerAsync(Ljava/lang/String;Lcom/parse/ParseSQLiteDatabase;)Lbolts/Task;
    invoke-static {v6, v4, v7}, Lcom/parse/OfflineStore;->access$700(Lcom/parse/OfflineStore;Ljava/lang/String;Lcom/parse/ParseSQLiteDatabase;)Lbolts/Task;

    move-result-object v6

    new-instance v7, Lcom/parse/OfflineStore$38$2;

    invoke-direct {v7, p0}, Lcom/parse/OfflineStore$38$2;-><init>(Lcom/parse/OfflineStore$38;)V

    invoke-virtual {v6, v7}, Lbolts/Task;->onSuccessTask(Lbolts/Continuation;)Lbolts/Task;

    move-result-object v6

    new-instance v7, Lcom/parse/OfflineStore$38$1;

    invoke-direct {v7, p0, v4}, Lcom/parse/OfflineStore$38$1;-><init>(Lcom/parse/OfflineStore$38;Ljava/lang/String;)V
    ...
    .line 1395
    .local v3, "unpinTask":Lbolts/Task;, "Lbolts/Task<Ljava/lang/Void;>;"
    invoke-interface {v2, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    goto :goto_1

    .line 1398
    .end local v3    # "unpinTask":Lbolts/Task;, "Lbolts/Task<Ljava/lang/Void;>;"
